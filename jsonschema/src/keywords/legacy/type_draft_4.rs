...
fn compile_single_type(item: &str, instance_path: Vec<String>) -> Option<CompilationResult> {
    match PrimitiveType::try_from(item) {
        Ok(PrimitiveType::Array) => Some(type_::ArrayTypeValidator::compile(instance_path)),
        Ok(PrimitiveType::Boolean) => Some(type_::BooleanTypeValidator::compile(instance_path)),
        Ok(PrimitiveType::Integer) => Some(IntegerTypeValidator::compile(instance_path)),
        Ok(PrimitiveType::Null) => Some(type_::NullTypeValidator::compile(instance_path)),
        Ok(PrimitiveType::Number) => Some(type_::NumberTypeValidator::compile(instance_path)),
        Ok(PrimitiveType::Object) => Some(type_::ObjectTypeValidator::compile(instance_path)),
        Ok(PrimitiveType::String) => Some(type_::StringTypeValidator::compile(instance_path)),
